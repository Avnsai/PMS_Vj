...
- Frontend was served over HTTPS: `https://typescript-fix-8.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://typescript-fix-8.preview.emergentagent.com` fallbacks
