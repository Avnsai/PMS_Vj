...
- Frontend was served over HTTPS: `https://typescript-debug.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://typescript-debug.preview.emergentagent.com` fallbacks
