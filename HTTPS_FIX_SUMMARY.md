...
- Frontend was served over HTTPS: `https://git-error-solve.preview.emergentagent.com`
...
**Changes:**
- Replaced hardcoded `https://git-error-solve.preview.emergentagent.com` fallbacks
