        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className="flex justify-between items-center mb-3">
            ...
            <span className={`text-2xl font-bold ${
              ...
              budgetUtilization > 70 ? 'text-yellow-600' : 'text-green-600'
          ...
          <div className="mt-2 text-sm text-gray-600">
            {budgetUtilization > 90 ? '⚠️ High utilization - Monitor spending closely' :
             budgetUtilization > 70 ? '⚡ Moderate utilization - Track remaining budget' :
             '✅ Healthy utilization - Good budget management'}
          </div>
        </div>
